...
/** Steps in the passkey-only authentication flow */
export type AuthStep = "choose" | "authenticate";
...
/** Steps for the passkey-only auth flow */
const STEPS: StepConfig[] = [
  { id: "choose", label: "Choose Action" },
...
/**
 * Stepper component for the passkey-only authentication flow.
 * Shows progress through: Choose Action -> Authenticate
 */
